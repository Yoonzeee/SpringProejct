            ...
            <div class="admin_wrap">
                ...
                <div class="admin_navi_wrap">
                	...
                	<div class="insert_wrap">
                		<form id="insertForm" action="/bookshop/admin/adminInsertGoods" method="post">
                			<div class="insert_input">
                				<a href="/bookshop/admin/goodsEnroll">
                    				<button class='insert_btn'>등 록</button>                				
                				</a>
                			</div>
                		</form>
                	</div>
                   ...
                   <div class="goods_table_wrap">
	                    	<table class="goods_table" id="foo_table">
	                    		...
	                    		<tr>
									...
									<td><a href="/bookshop/thumbnails.do?goods_id=${item.goods_id}&fileName=${fileName}">${item.goods_title}</a></td>
									<td>${item.goods_writer}</td>
									<td>${item.goods_publisher}</td>
									<td>${item.goods_price}</td>
									<td>${item.goods_sales_price}</td>
									<td>${item.goods_point}</td>
									<td><a href="#?goods_id=${item.goods_id}">삭제</a></td>
	                    		</tr>
	                    		</c:forEach>
	                    	</table>
                	</div>
