...
<body>
	...
	<div id="goods_image">
		<figure>
			<img alt="HTML5 &amp; CSS3"
				src="/bookshop/thumbnails.do?goods_id=${goods.goods_id}&fileName=${fileName}">
		</figure>
	</div>
	<div id="detail_table">
		<table>
		...
		<div class="tab_container">
			<div class="tab_content" id="tab1">
				...
				<c:forEach var="image" items="${imageList }">
					<img 
						src="/bookshop/download.do?goods_id=${goods.goods_id}&fileName=${image.fileName}">
				</c:forEach>
			</div>
	...
	<div id="layer" style="visibility: hidden">
		...
		<div id="popup">
			...
			<a href="javascript:" onClick="javascript:imagePopup('close', '.layer01');"> <img
				src="/bookshop/resources/image/close.png" id="close" />
